...
const _orderingYellow = Color(0xFFF4B400);
const _orderingInk = Color(0xFF3B2318);
const _orderingGreen = Color(0xFF2F9B42);
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _OrderingMascotIntro(compact: compact),
            SizedBox(height: compact ? 8 : 24),
            _QuestionCard(
...
class _OrderingMascotIntro extends StatelessWidget {
  const _OrderingMascotIntro({required this.compact});
            ...
            child: Text.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: 'Babe',
                    style: TextStyle(color: _orderingGreen),
                  ),
                  const TextSpan(
                    text:
        ...
        children: [
          Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _orderingYellow.withValues(alpha: 0.12),
          ...
          Text(
            question.instruction ?? 'Tekan dan geser untuk mengurutkan.',
            style: TextStyle(
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  padding: EdgeInsets.only(
                    bottom: index == items.length - 1 ? 0 : (compact ? 8 : 12),
                  ),
                  child: _OrderingItemCard(
                    item: items[index],
                    index: index,
                    compact: compact,
                  ),
          ...
          FilledButton(
            ...
            style: FilledButton.styleFrom(
              ...
              backgroundColor: _orderingYellow,
              foregroundColor: _orderingInk,
              elevation: 8,
...
class _OrderingItemCard extends StatelessWidget {
  const _OrderingItemCard({
    required this.item,
    required this.index,
    required this.compact,
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      constraints: BoxConstraints(minHeight: compact ? 54 : 70),
      padding: EdgeInsets.symmetric(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: const Color(0xFFFFE9A8), width: 3),
            ),
            child: Text(
              '${index + 1}',
              style: TextStyle(
